    ...
    <div class="overflow-x-auto rounded-lg border border-gray-800">
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-800">
          ...
          <tr v-if="!units?.length"><td colspan="9" class="px-4 py-8 text-center text-gray-500">No units defined yet.</td></tr>
        </tbody>
      </table>
    </div>
...
const blankForm = () => ({ key: '', name: '', category: 'soldier', health: 100, damage: 10, armor: 0, speed: 1.5, range: 1, sight: 5, training_time: 30, color: '#ffffff', faction_id: null, cost: { gold: 50, food: 1 } });
